...
public class BeanServicio {
    ...
    @Bean
    public ServicioEliminarProductoCarrito servicioEliminarProductoCarrito(RepositorioCarrito repositorioCarrito) {
        return new ServicioEliminarProductoCarrito(repositorioCarrito);
    }
